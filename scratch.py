...
# order receipts from digikey follow a rigid format. This dictionary defines the keywords to locate data we want.
# text.find can then be used to easily find the starting index and end index of the string.
